...
suite("Unit Tests", function () {
  // understand what suite is and how this tests are executed; FCC tests have anything to do with it? And what is the purpose of the TEST in the env file?
  ...
  suite("Function convertHandler.getUnit(input)", function () {
    ...
    test("Unkown Unit Input", function (done) {
      assert.equal(convertHandler.getUnit("34oz"), undefined);
      done();
    });
  });
